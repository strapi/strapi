...
module.exports = async function(config) {
  ...
  await Promise.all([
    loadHookDependencies(installedHooks, hooks, fileExtensions),
    // local middleware
    loadLocalHooks(appPath, hooks, fileExtensions),
    // plugins middlewares
    loadPluginsHooks(installedPlugins, hooks, fileExtensions),
    // local plugin middlewares
    loadLocalPluginsHooks(appPath, hooks, fileExtensions),
  ]);
