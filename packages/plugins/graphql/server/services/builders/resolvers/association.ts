...
interface BuildAssociationResolverArg {
...
export default ({ strapi }: StrapiCTX) => {
  ...
  return {
    buildAssociationResolver({ contentTypeUID, attributeName }: BuildAssociationResolverArg) {
      ...
      return async (parent: any, args = {}, context = {}) => {
