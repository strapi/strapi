  ...
  React.useEffect(() => {
    ...
    style.textContent = `
      .light-mode {
        ...
        --scalar-button-1: #4945ff;
        --scalar-button-1-color: #ffffff;
        --scalar-button-1-hover: #271fe0;
      }
      ...
      .dark-mode {
        ...
        --scalar-button-1: #7b79ff;
        --scalar-button-1-color: #ffffff;
        --scalar-button-1-hover: #6b69ff;
      }
      [data-theme-selector],
      .theme-selector,
    ...
    const initializeScalar = () => {
      ...
      if ((window as any).Scalar) {
        (window as any).Scalar.createApiReference('#scalar-app', {
          ...
          tagsSorter: 'alpha',
          operationsSorter: (a: { path: string; method: string }, b: { path: string; method: string }) =>
