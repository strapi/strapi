...
describe('Admin | containers | RoleCreatePage', () => {
  ...
  it('renders users-permissions create role and matches snapshot', async () => {
    ...
    expect(container.firstChild).toMatchInlineSnapshot(`
      ...
      .c39:hover:not([aria-disabled='true']) .sc-bQbCr {
        color: #271fe0;
      }

      .c39:hover:not([aria-disabled='true']) .c48 {
        color: #4945ff;
      }

      .c39:hover:not([aria-disabled='true']) > .c40 {
        background: #f0f0ff;
      }

      .c39:hover:not([aria-disabled='true']) [data-strapi-dropdown='true'] {
        background: #d9d8ff;
      }
