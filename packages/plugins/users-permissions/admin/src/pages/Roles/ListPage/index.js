...
const RoleListPage = () => {
  ...
  const updatePermissions = useMemo(() => {
    return {
      create: pluginPermissions.createRole,
      read: pluginPermissions.readRoles,
      update: pluginPermissions.updateRole,
      delete: pluginPermissions.deleteRole,
    };
  }, []);
    ...
    <Layout>
      ...
      <Main aria-busy={isLoading}>
        <HeaderLayout
          ...
          primaryAction={
            <CheckPermissions permissions={pluginPermissions.createRole}>
