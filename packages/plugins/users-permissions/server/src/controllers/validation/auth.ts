...
export const validateRegisterBody = (payload, config) =>
...
export const validateEmailConfirmationBody = validateYupSchema(validateEmailConfirmationSchema);
export const validateForgotPasswordBody = validateYupSchema(forgotPasswordSchema);
export const validateResetPasswordBody = (payload, config) =>
  validateYupSchema(createResetPasswordSchema(config))(payload);
export const validateChangePasswordBody = (payload, config) =>
