// Copied from packages/plugins/branches/server/src/codec/__tests__/codec.test.ts —
// keep structurally in sync (three-way-merge coverage removed: channels has no merge).
import {
  applyRelationInput,
  diffSnapshots,
  fromDocument,
...
describe('diffSnapshots / mergeChangeSets', () => {
