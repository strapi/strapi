...
import { checkLocaleTableHook } from './contentReleaseHooks/detailsView';
...
export default {
  ...
  bootstrap(app: any) {
    ...
    // Hooks that checks if the locale column needs to be shown in the table
    app.registerHook('ContentReleases/pages/DetailsView/check-locale', checkLocaleTableHook);
