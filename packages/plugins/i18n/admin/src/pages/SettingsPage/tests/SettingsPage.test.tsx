...
jest.mock('@strapi/helper-plugin', () => {
  return {
    ...
    ModalConfirm: ({ onConfirm, isOpen }: any) =>
      isOpen ? (
        <div role="dialog">
    ...
    Modal: ({ isOpen, children }: any) => isOpen && <div role="dialog">{children}</div>,
    ModalHeader: ({ children }: any) => <div>{children}</div>,
    ModalSection: ({ children }: any) => <div>{children}</div>,
    ModalFooter: ({ children }: any) => <div>{children}</div>,
    HeaderModal: ({ children }: any) => <div>{children}</div>,
    HeaderModalTitle: ({ children }: any) => <div>{children}</div>,
    ModalForm: ({ children }: any) => <div>{children}</div>,
    ListButton: () => <div />,
    Tabs: ({ children }: any) => <div>{children}</div>,
    TabsNav: ({ children }: any) => <div>{children}</div>,
    Tab: ({ children }: any) => <div>{children}</div>,
    TabsPanel: ({ children }: any) => <div>{children}</div>,
