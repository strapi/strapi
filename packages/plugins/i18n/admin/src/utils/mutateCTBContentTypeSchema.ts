...
const addLocalisationToFields = (attributes: any) =>
...
const disableAttributesLocalisation = (attributes: any) =>
  Object.keys(attributes).reduce((acc, current) => {
...
const mutateCTBContentTypeSchema = (nextSchema: any, prevSchema: any) => {
