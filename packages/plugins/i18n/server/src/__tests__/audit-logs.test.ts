...
describe('i18n audit events', () => {
  ...
  test('locale.create', () => {
    ...
    expect(
      transform({ localeId: 2, name: 'French (France)', code: 'fr', isDefault: false })
    ).toEqual({
  ...
  test('locale.update', () => {
    ...
    expect(transform({ localeId: 2, name: 'French (France)', code: 'fr', changes })).toEqual({
      resource: { type: 'locale', id: 2, name: 'French (France)', code: 'fr' },
      details: { changes },
    });
  });
  ...
  test('locale.delete carries no details', () => {
    ...
    expect(transform({ localeId: 2, name: 'French (France)', code: 'fr' })).toEqual({
      resource: { type: 'locale', id: 2, name: 'French (France)', code: 'fr' },
    });
  });
  ...
  test('locale.default.update points at the new default locale', () => {
    ...
    expect(transform({ localeId: 1, name: 'French (France)', code: 'fr', changes })).toEqual({
  ...
  test('locale.default.update records no previous default on the first one', () => {
    ...
    expect(transform({ localeId: 1, name: 'English (en)', code: 'en', changes })).toEqual({
