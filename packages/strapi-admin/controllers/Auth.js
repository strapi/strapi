...
module.exports = {
  ...
  async changePassword(ctx) {
    ...
    const { password, passwordConfirmation, currentPassword } = {
      ...ctx.request.body,
      ...ctx.params,
    };
    ...
    const data = {
      password: await strapi.admin.services.auth.hashPassword(currentPassword),
    };

    await strapi.query('administrator', 'admin').update({ id: admin.id }, data);
