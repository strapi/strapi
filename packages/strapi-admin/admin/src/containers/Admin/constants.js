...
export const GET_INIT_DATA_SUCCEEDED = 'StrapiAdmin/Admin/GET_INIT_DATA_SUCCEEDED';
export const GET_SECURED_DATA = 'StrapiAdmin/Admin/GET_SECURED_DATA';
export const GET_SECURED_DATA_SUCCEEDED = 'StrapiAdmin/Admin/GET_SECURED_DATA_SUCCEEDED';
