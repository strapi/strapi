...
class InputGJSONWithErrors extends React.Component { // eslint-disable-line react/prefer-stateless-function
...
InputGJSONWithErrors.defaultProps = {
  autoFocus: false,
  className: '',
...
InputGJSONWithErrors.propTypes = {
...
export default InputGJSONWithErrors;
