import { StrapiCoreRegistries } from "../core/registries/types";
...
export type RegistryResolver<T extends Registry> =
  | T
  | ((ctx: { strapi: Strapi }, args?: any) => T);
...
export interface StrapiRegistryContainer {
  ...
  get<K extends keyof StrapiRegistries>(
    name: K,
    args?: any
  ): StrapiRegistries[K];
  extend(): void;
