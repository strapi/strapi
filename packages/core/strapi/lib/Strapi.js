...
const createAuthRegistry = require('./services/auth');
const createUpdateNotifier = require('./utils/update-notifier');
const createStartupLogger = require('./utils/startup-logger');
const ee = require('./utils/ee');
const createContentTypesRegistry = require('./core/registries/content-types');
const createServicesRegistry = require('./core/registries/services');
const createPoliciesRegistry = require('./core/registries/policies');
const createMiddlewaresRegistry = require('./core/registries/middlewares');
const createHooksRegistry = require('./core/registries/hooks');
const createControllersRegistry = require('./core/registries/controllers');
const createModulesRegistry = require('./core/registries/modules');
const createPluginsRegistry = require('./core/registries/plugins');
const createConfigProvider = require('./core/registries/config');
const createApisRegistry = require('./core/registries/apis');
...
class Strapi {
  constructor(opts = {}) {
    ...
    this.container.register('config', createConfigProvider(this, appConfig));
    this.container.register('content-types', createContentTypesRegistry(this));
    this.container.register('services', createServicesRegistry(this));
    this.container.register('policies', createPoliciesRegistry(this));
    this.container.register('middlewares', createMiddlewaresRegistry(this));
    this.container.register('hooks', createHooksRegistry(this));
    this.container.register('controllers', createControllersRegistry(this));
    this.container.register('modules', createModulesRegistry(this));
    this.container.register('plugins', createPluginsRegistry(this));
    this.container.register('apis', createApisRegistry(this));
    this.container.register('auth', createAuthRegistry(this));
