 ...
 */
interface ModelRBACContextValue {
  canCreate?: boolean;
...
const [ModelRBACProvider, useModelRBAC] = createContext<ModelRBACContextValue>('ModelRBAC', {
  canCreate: false,
  canCreateFields: [],
  canDelete: false,
  canPublish: false,
 ...
 * It depends on knowing the model of the content-type using an argument passed.
 ...
 */
const ModelRBAC = ({ children, permissions, model }: ModelRBACProps) => {
  ...
  const contentTypePermissions = React.useMemo(() => {
    const contentTypePermissions = userPermissions.filter(
      (permission) => permission.subject === model
    );
   ...
   */
  const canUserAction: ModelRBACContextValue['canUserAction'] = React.useCallback(
...
export { ModelRBAC, useModelRBAC, ModelRBACContextValue, ModelRBACProps };
