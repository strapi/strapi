import { getInnerErrors } from '../validation';

import type { ValidationError } from 'yup';

describe('validation', () => {
  describe('getInnerErrors', () => {
    test('can extract relevant parameters from an error', () => {
      ...
      expect(getInnerErrors(maxError)).toMatchObject({
        number: {
    ...
    test('can extract error messages from multiple errors', () => {
      ...
      expect(getInnerErrors(multipleErrors)).toMatchObject({
        json: {
