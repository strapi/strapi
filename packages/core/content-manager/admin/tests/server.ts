...
export const handlers: RequestHandler[] = [
  ...
  rest.get('/admin/content-manager/collection-types/:contentType/stages', (req, res, ctx) =>
    res(
      ctx.json({
        data: [
          {
  ...
  rest.get('/admin/content-manager/single-types/:contentType/stages', (req, res, ctx) =>
    res(
      ctx.json({
        data: [
          {
