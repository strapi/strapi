...
export default () => ({
  toContentManagerModel(contentType: Internal.Struct.ComponentSchema) {
    return {
      ...contentType,
...
const formatAttributes = (contentType: Internal.Struct.ComponentSchema) => {
...
const isVisible = (model: Internal.Struct.ComponentSchema): boolean =>
