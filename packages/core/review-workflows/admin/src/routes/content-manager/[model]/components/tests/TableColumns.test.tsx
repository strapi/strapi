...
describe('TableColumns', () => {
  describe('StageColumn', () => {
    test('render stage name', () => {
      const { getByText } = render(<StageColumn color="#4945FF" name="reviewed" />);
  ...
  describe('AssigneeColumn', () => {
    ...
    test('render assignee name', () => {
      const { getByText } = render(<AssigneeColumn user={USER_FIXTURE} />);
    ...
    test('will use username over first and last name', () => {
      ...
      const { getByText } = render(<AssigneeColumn user={{ ...USER_FIXTURE, username }} />);
