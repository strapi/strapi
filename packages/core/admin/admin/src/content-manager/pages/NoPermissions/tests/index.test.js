            ...
            >
              ...
              >
                <path
                  ...
                  fill="url(#empty-state-permissions_svg__pattern0)"
                />
                <defs>
                  <pattern
                    height="1"
                    id="empty-state-permissions_svg__pattern0"
                    patternContentUnits="objectBoundingBox"
                    width="1"
                  >
                    <use
                      transform="matrix(.00198 0 0 .00321 0 -.001)"
                      xlink:href="#empty-state-permissions_svg__image0"
                    />
                  </pattern>
                  <image
                    height="312"
                    id="empty-state-permissions_svg__image0"
                    width="504"
