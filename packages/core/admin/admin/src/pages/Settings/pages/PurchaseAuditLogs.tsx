...
import darkIllustration from '../assets/purchase-page-audit-logs-illustration-dark.png';
import lightIllustration from '../assets/purchase-page-audit-logs-illustration-light.png';
