...
import { useTransferTokenPermissionsContext } from '../../../../../../../contexts/TransferTokenPermissions';
      ...
      {selectedAction ? (
        ...
        <Stack spacing={2}>
          <Typography variant="delta" as="h3">
            {formatMessage({
              id: 'Settings.transferTokens.createPage.permissions.header.title',
              defaultMessage: 'Advanced settings',
            })}
          </Typography>
          <Typography as="p" textColor="neutral600">
            {formatMessage({
              id: 'Settings.transferTokens.createPage.permissions.header.hint',
              defaultMessage:
