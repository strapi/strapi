...
const madeByStrapiResponseData = {
  data: [
    {
...
const customFieldsResponseData = {
...
export const responses = {
  plugins,
  'Made by Strapi': madeByStrapiResponseData,
  'Custom fields': customFieldsResponseData,
  Verified: verifiedResponseData,
  Monitoring: monitoringResponseData,
};
