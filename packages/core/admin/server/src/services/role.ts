 ...
 * @returns {Promise<array>}
 */
const deleteByIds = async (ids = [] as (string | number)[]) => {
 ...
 */
const getUsersCount = async (roleId: string): Promise<number> => {
 ...
 */
const assignPermissions = async (roleId: string | number, permissions = []) => {
...
const addPermissions = async (roleId: string | number, permissions: any) => {
