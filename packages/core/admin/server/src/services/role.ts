...
const jsonClean = (data: any) => JSON.parse(JSON.stringify(data));
 ...
 * @returns {boolean}
 */
const arePermissionsEqual = (p1: any, p2: any) => {
 ...
 * @returns {Promise<role>}
 */
const findOne = (params = {} as any, populate?: any) => {
 ...
 * @param roleId
 */
const getUsersCount = async (roleId: string) => {
 ...
 */
const assignPermissions = async (roleId: string, permissions = []) => {
...
const addPermissions = async (roleId: string, permissions: any) => {
...
const isContentTypeAction = (action: any) => action.section === CONTENT_TYPE_SECTION;
