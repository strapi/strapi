...
export type GetTarget<TSchemaUID extends Common.UID.Schema, TKey extends GetKeys<TSchemaUID>> =
...
export type GetValueByKey<TSchemaUID extends Common.UID.Schema, TKey extends GetKeys<TSchemaUID>> =
  Get<TSchemaUID, TKey> extends infer TAttribute extends Attribute.Attribute
    ? GetValue<TAttribute>
    : never;
