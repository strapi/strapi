import { scryptSync, type CipherKey, type BinaryLike, createDecipheriv } from 'crypto';
import type { EncryptionStrategy, Strategies, Algorithm } from '../../types';

// @types/node 20.x names this class Decipher; 24.x renames it to Decipheriv. Derive via ReturnType so signatures hold across both.
