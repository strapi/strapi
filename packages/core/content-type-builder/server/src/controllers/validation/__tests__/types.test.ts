...
describe('Type validators', () => {
  test('pluginOptions can be used', () => {
    ...
    } satisfies Internal.Struct.SchemaAttributes;
  ...
  describe('media type', () => {
    test('Validates allowedTypes', () => {
      // @ts-expect-error - Silence the cast as Internal.Struct.SchemaAttributes since allowedTypes expects one of 'audios',
      ...
      } as Internal.Struct.SchemaAttributes;
