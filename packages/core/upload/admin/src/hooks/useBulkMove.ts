...
import { BulkMoveFiles, Asset } from '../../../shared/contracts/files';
import { BulkMoveFolders, Folder } from '../../../shared/contracts/folders';
...
interface BulkMoveParams {
  ...
  filesAndFolders: Array<FolderWithType | AssetWithType>;
}
