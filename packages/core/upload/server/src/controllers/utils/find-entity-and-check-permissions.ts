...
import { errors, contentTypes as contentTypesUtils, structuredCloneSafe } from '@strapi/utils';
...
const findEntityAndCheckPermissions = async (
  ...
  const fileWithRoles = _.set(structuredCloneSafe(file), 'createdBy', author);
