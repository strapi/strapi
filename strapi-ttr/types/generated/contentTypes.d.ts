...
export interface ApiNavigationBarNavigationBar
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    subNavigation: Schema.Attribute.Relation<
      'oneToMany',
      'api::sub-navigation.sub-navigation'
    >;
...
export interface ApiSubNavigationSubNavigation
  extends Struct.CollectionTypeSchema {
  collectionName: 'sub_navigations';
  info: {
    description: '';
    displayName: 'Sub Navigation';
    pluralName: 'sub-navigations';
    singularName: 'sub-navigation';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::sub-navigation.sub-navigation': ApiSubNavigationSubNavigation;
