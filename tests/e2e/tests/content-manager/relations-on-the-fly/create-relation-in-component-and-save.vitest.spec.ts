...
// AUTO-GENERATED from docs/user-stories/content-manager/relations-on-the-fly/create-relation-in-component-and-save.md by `strapi user-stories:sync-e2e`.
...
describe('Relations on the Fly - Create a Relation Inside a Component and Save', () => {
  describe('Create a relation inside an existing component and save it', () => {
    // Then the relation modal opens showing "Create a relation" and an "Untitled" heading
    test.todo('AC1.1 — the relation modal opens showing "Create a relation" and an "Untitled…');

    // Then the name is kept and a "Draft" status is shown
    test.todo('AC1.2 — the name is kept and a "Draft" status is shown');

    // Then "Nike Zoom Kd Iv Gold C800" is shown as a related product button on the component
    test.todo('AC1.3 — "Nike Zoom Kd Iv Gold C800" is shown as a related product button on t…');
  });
});
