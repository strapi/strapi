...
// AUTO-GENERATED from docs/user-stories/content-type-builder/single-type/create-single-type.md by `strapi user-stories:sync-e2e`.
...
describe('Create a Single Type with All Field Types', () => {
  describe('Create a single type covering every field type', () => {
    // Given the Content-Type Builder is open
    // When the user creates a single type named "Secret Document" (singular id `secret-document`)
    // Then the single type is created end to end
    test.todo('AC1.1 — the user creates a single type named "Secret Document" (singular id `…');

    // Given the new single type is open
    ...
    test.todo('AC1.7 — the user adds Relation fields for the oneWay and manyWay types');
