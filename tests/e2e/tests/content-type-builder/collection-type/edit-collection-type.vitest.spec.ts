...
// AUTO-GENERATED from docs/user-stories/content-type-builder/collection-type/edit-collection-type.md by `strapi user-stories:sync-e2e`.
...
describe('Edit a Collection Type', () => {
  describe('Change a relation type from manyToOne to oneToOne', () => {
    // Given the "Article" collection type is open
  ...
  describe('Configure advanced settings for multiple fields sequentially', () => {
    ...
    // Then the content type heading is visible
    test.todo('AC5.3 — the user saves and the server restarts');
  });

  describe('Rename a content type', () => {
    // Given the "Article" collection type is open
  ...
  describe('Delete a content type', () => {
    ...
    // Then the content type is removed
