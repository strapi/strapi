  ...
  const hook = {
    ...
    initialize: function (cb) {
      async.auto({
        ...
        // Load admin controllers from `./admin/api/controllers/*.js`.
        ...
        // Load admin models from `./admin/api/models/*.js` and `./admin/api/models/*.settings.json`.
        'models/*': function (cb) {
          async.parallel({
        ...
        // Load admin services from `./admin/api/services/*.js`.
        ...
        // Load admin policies from `./admin/api/policies/*.js`.
