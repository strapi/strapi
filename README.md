...
- **Self-hosted**. Projects in Strapi can be hosted and scaled however you like. You can choose any hosting platform you want: AWS, Render, Netlify, Heroku, a VPS, or a dedicated server. You can scale as you grow, 100% independent.
