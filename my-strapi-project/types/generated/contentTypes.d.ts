...
export interface ApiDisplayDisplay extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    BOOL: Schema.Attribute.Boolean & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    INT: Schema.Attribute.Decimal & Schema.Attribute.Required;
    JSON: Schema.Attribute.Blocks;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::display.display'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
