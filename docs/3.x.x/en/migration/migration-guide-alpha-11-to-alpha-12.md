# Migrating from 3.0.0-alpha.11 to 3.0.0-alpha.12.3

This migration guide is a mix of migrations from 3.0.0-alpha.11.1 to 3.0.0-alpha.11.2, 3.0.0-alpha.11.2 to 3.0.0-alpha.11.3 and from 3.0.0-alpha.11.3 to 3.0.0-alpha.12.3.
...
- Edit the Strapi's dependencies version: (move Strapi's dependencies to `3.0.0-alpha.12.3` version) in `package.json` file
