...
Please refer to the [new documentation](https://github.com/strapi/strapi/blob/master/docs/3.0.0-beta.0/en/configurations/configurations.md) to set the correct values in each file.
