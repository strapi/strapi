...
Then on each request, send along an `Authorization` header in the form of `{ Authorization: "Bearer YOUR_JTW_GOES_HERE" }`. This can be set in the HTTP Headers section of your GraphQL Playground.
