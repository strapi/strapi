...
By default, the Community Edition (CE) will be limited to 3 pre-defined roles (Administrators, Author). Upgrading to the Enterprise Edition (EE) will allow customers to create an unlimited number of customizable roles.
