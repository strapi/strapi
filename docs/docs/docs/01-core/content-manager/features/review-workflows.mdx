...
can select any other stage of the current workflow provided they have the necessary permissions to change the current stage see [EE Review Workflows](/docs/core/admin/01-ee/01-review-workflows).
