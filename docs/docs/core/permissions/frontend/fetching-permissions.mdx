...
The data is then passed to the `RBACProvider` comoponent which passes it to a public facing [React Context](https://beta.reactjs.org/learn/passing-data-deeply-with-context)
