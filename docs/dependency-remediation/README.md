...
| 4     | `prebuild-install` solutions                        | in progress | [04-prebuild-install.md](./04-prebuild-install.md) |
| 5     | Replace `umzug` safely                              | done        | [05-umzug.md](./05-umzug.md)                       |
| 6     | `nodemailer` 8→9 + draft PR?                        | in progress | [06-nodemailer.md](./06-nodemailer.md)             |
| 7     | `preferred-pm` 3→5                                  | in progress | [07-preferred-pm.md](./07-preferred-pm.md)         |
| 8     | OAuth stack removal (`grant`/`purest`/`jwk-to-pem`) | in progress | [08-oauth-stack.md](./08-oauth-stack.md)           |
