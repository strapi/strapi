...
- Create a `./src/_data` folder containing a `categories.js` and a `restaurants.js` file. They will be used to fetch your content on Strapi
...
- Create a `./src/index.md`, `./src/restaurants.md` and a `./src/categories.md` file. They will define how you'll present the data.
- Create a `./eleventy.js` file containing the following:
