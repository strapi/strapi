...
This is a step-by-step guide for deploying a Strapi project on [IBM Cloud](https://www.ibm.com/cloud). Among the available alternatives, this guide covers the deployment on [IBM Cloud Foundry](https://www.cloudfoundry.org/the-foundry/ibm-cloud-foundry) using the official databases services.
...
Download and install the [CLI](https://cloud.ibm.com/docs/cli) for your operating system:
...
Create a Strapi project with MongoDB [section of the documentation](../guides/databases.md#install-strapi-locally-with-mongodbb). But don't worry about the username and password for now. For convenience we´re going to use the URI instead.
