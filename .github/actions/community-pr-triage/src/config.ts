...
export const LINEAR_CPR_TEAM_ID = process.env.LINEAR_CPR_TEAM_ID ?? '';

export const LINEAR_CMS_TEAM_ID = process.env.LINEAR_CMS_TEAM_ID ?? '';

export const LINEAR_CMS_GITHUB_TEAM_ID = process.env.LINEAR_CMS_GITHUB_TEAM_ID ?? '';

export const LINEAR_PROJECT_ID = process.env.LINEAR_PROJECT_ID ?? '';
...
export function validateConfig(): void {
  const required = [
    ['LINEAR_CPR_TEAM_ID', LINEAR_CPR_TEAM_ID],
    ['LINEAR_CMS_TEAM_ID', LINEAR_CMS_TEAM_ID],
