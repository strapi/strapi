...
export default defineConfig({
  test: {
    env: {
      ...
      LINEAR_CMS_GITHUB_TEAM_ID: 'test-cms-team-id',
      LINEAR_SPRINT_PROJECT_ID: 'test-sprint-project-id',
      LINEAR_STATUS_TRIAGE: 'test-status-triage',
      ...
      LINEAR_SOURCE_LABELS: JSON.stringify({
