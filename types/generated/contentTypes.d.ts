...
export interface ApiBookmakerBonnusBookmakerBonnus
  ...
  info: {
    displayName: 'BookmakerBonnus';
    pluralName: 'bookmaker-bonnuses';
    singularName: 'bookmaker-bonnus';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    bookmaker_page: Schema.Attribute.Relation<
      'manyToOne',
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::bookmaker-bonnus.bookmaker-bonnus'
    >;
    name: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiBookmakerPageBookmakerPage
  extends Struct.CollectionTypeSchema {
  collectionName: 'bookmaker_pages';
  info: {
    displayName: 'BookmakerPage';
    pluralName: 'bookmaker-pages';
    singularName: 'bookmaker-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    >;
    bookmaker_bonnuses: Schema.Attribute.Relation<
      'oneToMany',
      'api::bookmaker-bonnus.bookmaker-bonnus'
    >;
    ...
    rewiew: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCasinoBonnusCasinoBonnus
  extends Struct.CollectionTypeSchema {
  collectionName: 'casino_bonnuses';
  info: {
    displayName: 'CasinoBonnus';
    pluralName: 'casino-bonnuses';
    singularName: 'casino-bonnus';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCasinoPageCasinoPage extends Struct.CollectionTypeSchema {
  collectionName: 'casino_pages';
  info: {
    displayName: 'CasinoPage';
...
export interface ApiMatchMatch extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    odd_options: Schema.Attribute.Relation<
      'oneToMany',
      'api::odd-option.odd-option'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiOddOptionOddOption extends Struct.CollectionTypeSchema {
  collectionName: 'odd_options';
  info: {
    displayName: 'OddOption';
    pluralName: 'odd-options';
    singularName: 'odd-option';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    odds: Schema.Attribute.Relation<'oneToMany', 'api::odd.odd'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiOddOdd extends Struct.CollectionTypeSchema {
  collectionName: 'odds';
  info: {
    displayName: 'Odd';
    pluralName: 'odds';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::odd.odd'>;
    odd_option: Schema.Attribute.Relation<
      'manyToOne',
      'api::odd-option.odd-option'
    >;
    oddStatus: Schema.Attribute.Enumeration<
      ['Finished', 'Waiting_for_match', 'Canceled']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiUserSocialUserSocial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    followers: Schema.Attribute.Decimal &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    benefit: Schema.Attribute.Decimal;
    blocked: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    clv: Schema.Attribute.Decimal;
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    subscribers: Schema.Attribute.Decimal;
    telegramChannel: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::casino-bonnus.casino-bonnus': ApiCasinoBonnusCasinoBonnus;
      ...
      'api::odd-option.odd-option': ApiOddOptionOddOption;
